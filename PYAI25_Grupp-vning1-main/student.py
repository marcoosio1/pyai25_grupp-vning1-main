...
def read_students():
    ...
    try:
        with open("students.json", "r", encoding="utf-8") as f:
            ...
            students = {int(id): student_data for id, student_data in students.items()} #Konverterar tillbaka id-nyckeln till int från str
                                                                                        # då json sparar allt som str.
...
############################################ Add course ############################################################
    ...
    if val == "2":
        ...
        try:
            ...
            output = add_course(student_id, course)
...
############################################ Remove course ############################################################
    ...
    if val == "3":
        ...
        try:
            ...
            output = remove_course(student_id, course)
